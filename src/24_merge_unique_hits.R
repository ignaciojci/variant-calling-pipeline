setwd("/fs/scratch/PAS2444/jignacio/2024/pm/data/22_unique_blast_hits/")
...
outfile <- "/fs/scratch/PAS2444/jignacio/2024/pm/data/16_merged_high_call_rate_vcf/filtered_marker_list.bed"
