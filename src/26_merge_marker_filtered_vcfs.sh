...
# Run with:
# sbatch --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/26_merge_marker_filtered_vcfs.sh
#
...
indir="${homedir}/data/25_filtered_markers_vcf"
outdir="${homedir}/data/26_filtered_markers_merged_vcf"
mkdir -p $outdir
