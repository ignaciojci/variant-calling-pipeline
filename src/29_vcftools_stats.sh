...
# sbatch -a 1 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
# sbatch -a 2-935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
# arange -t 2-468 --log mark_dp0_as_missing.log32985220 --summary
# sbatch -a 469-935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
# failedjobs=277,386-390,392,394,396,398-401,403-410
# sbatch -a 29 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
# sbatch -a $failedjobs --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
# sbatch -a 412 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
...
# sbatch -a $failedjobs2 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/29_vcftools_stats.sh
...
vcftools --gzvcf "$input" --missing-indv --out "${outdir}/missing"
