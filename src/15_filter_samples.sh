...
#SBATCH --job-name=filter_samples
...
# sbatch -a 1 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
# sbatch -a 2-468 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
# arange -t 2-468 --log mark_dp0_as_missing.log32985220 --summary
# sbatch -a 469-935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
# failedjobs=277,386-390,392,394,396,398-401,403-410
# sbatch -a 29 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
# sbatch -a $failedjobs --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
# sbatch -a 412 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
...
# sbatch -a $failedjobs2 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/15_filter_samples.sh
...
outdir="${homedir}/data/d15_filtered_high_call_rate_vcf"
mkdir -p $outdir
...
samples_to_keep_file="/users/PAS1286/jignacio/projects/pm/data/12_merged_vcf/dart_lines_with_call_rate_over_30.txt"
