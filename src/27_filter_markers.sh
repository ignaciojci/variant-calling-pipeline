...
# sbatch -a 1-935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/27_filter_markers.sh
# sbatch -a 1 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/27_filter_markers.sh
# sbatch -a 1-468 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/27_filter_markers.sh
# arange -t 2-468 --log mark_dp0_as_missing.log32985220 --summary
# sbatch -a 469-935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/27_filter_markers.sh
set -u -o pipefail -x
...
outdir="${homedir}/data/27_filter_markers_three_vcfs"
mkdir -p $outdir
...
markers_to_keep_file="/users/PAS1286/jignacio/projects/pm/data/27_filter_markers_three_vcfs/markers_of_three_vcfs.bed"
