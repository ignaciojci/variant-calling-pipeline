...
#SBATCH --job-name=vcf_merge_high_callrate
...
# Run with:
# sbatch --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/16_merge_sample_filtered_vcfs.sh
#
...
outdir="${homedir}/data/d16_merged_high_call_rate_vcf"
mkdir -p $outdir
