...
#SBATCH --job-name=mark_dp0_as_missing
...
# sbatch -a 935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
# sbatch -a 2-482 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
# arange -t 2-482 --log mark_dp0_as_missing.log32985220 --summary
# sbatch -a 484-935 --export=project_idx=0 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
# failedjobs=277,386-390,392,394,396,398-401,403-410
# sbatch -a 29 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
# sbatch -a $failedjobs --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
# sbatch -a 412 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
...
# sbatch -a $failedjobs2 --export=project_idx=0 --cpus-per-task=2 /users/PAS1286/jignacio/projects/pm/src/10_mark_dp0_as_missing.sh
...
indir="${homedir}/data/09_output_vcf_uncalibrated"
outdir="${homedir}/data/10_mark_dp0_as_missing"
mkdir -p $outdir
